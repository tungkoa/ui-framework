...
const __1 = require("../");
const httpsRedirect = () => {
    const httpsRedirect = (0, http_1.createServer)((req, res) => {
...
const main = async () => {
    httpsRedirect();
    const server = new __1.TinyServerHttp2();
    const route = server.route;
    route.logger();
    route.static('/static', (0, path_1.join)((0, path_1.resolve)(), 'www'));
