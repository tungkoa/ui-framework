var n = require("preact"), t = require("preact/hooks");
...
var f = function (t, e) {
  ...
  map: f, forEach: f, count: function (t) {
...
var E = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103,
  C = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,
  O = /^on(Ani|Tra|Tou|BeforeInp|Compo)/, R = /[A-Z0-9]/g, w = "undefined" != typeof document, j = function (n) {
...
n.options.event = function (n) {
  return k && (n = k(n)), n.persist = M, n.isPropagationStopped = T, n.isDefaultPrevented = A, n.nativeEvent = n
};
var D, L = {
...
n.options.vnode = function (t) {
  "string" == typeof t.type && function (t) {
    ...
    })), e.class && !e.className ? (u.class = e.class, Object.defineProperty(u, "className", L)) : (e.className && !e.class || e.class && e.className) && (u.class = u.className = e.className), t.props = u
  }(t), t.$$typeof = E, F && F(t)
};
var U = n.options.__r;
...
n.options.diffed = function (n) {
  ...
  null != e && "textarea" === n.type && "value" in t && t.value !== e.value && (e.value = null == t.value ? "" : t.value), D = null
};
var W = {
...
var nn = t.useLayoutEffect, tn = z;

function en(n, e) {
  var r = e(), u = t.useState({p: {__: r, h: e}}), o = u[0].p, i = u[1];
  return t.useLayoutEffect(function () {
    o.__ = r, o.h = e, rn(o) && i({p: o})
  }, [n, r, e]), t.useEffect(function () {
    return rn(o) && i({p: o}), n(function () {
      rn(o) && i({p: o})
    })
  }, [n]), r
}
