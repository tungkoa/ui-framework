var n, l, t, u, i, o, r, e, f, c, s, h, p = {}, a = [],
...
function M() {
  var n, t, u, o, r, f, c, s;
  for (i.sort(e); n = i.shift();) n.__d && (t = i.length, o = void 0, f = (r = (u = n).__v).__e, c = [], s = [], u.__P && ((o = d({}, r)).__v = r.__v + 1, l.vnode && l.vnode(o), A(u.__P, o, r, u.__n, u.__P.namespaceURI, 32 & r.__u ? [f] : null, c, null == f ? m(r) : f, !!(32 & r.__u), s), o.__v = r.__v, o.__.__k[o.__i] = o, F(c, o, s), o.__e != f && b(o)), i.length > t && i.sort(e));
  M.__r = 0
}
...
function L(n, l, t, u, i) {
  var o;
  n:if ("style" === l) if ("string" == typeof t) n.style.cssText = t; else {
    if ("string" == typeof u && (n.style.cssText = u = ""), u) for (l in u) t && l in t || H(n.style, l, "");
    if (t) for (l in t) u && t[l] === u[l] || H(n.style, l, t[l])
  } else if ("o" === l[0] && "n" === l[1]) o = l !== (l = l.replace(/(PointerCapture)$|Capture$/i, "$1")), l = l.toLowerCase() in n || "onFocusOut" === l || "onFocusIn" === l ? l.toLowerCase().slice(2) : l.slice(2), n.l || (n.l = {}), n.l[l + o] = t, t ? u ? t.t = u.t : (t.t = f, n.addEventListener(l, o ? s : c, o)) : n.removeEventListener(l, o ? s : c, o); else {
...
function T(n) {
  return function (t) {
    if (this.l) {
      ...
      if (null == t.u) t.u = f++; else if (t.u < u.t) return;
...
function A(n, t, u, i, o, r, e, f, c, s) {
  ...
  128 & u.__u && (c = !!(32 & u.__u), r = [f = t.__e = u.__e]), (h = l.__b) && h(t);
  n:if ("function" == typeof T) try {
    if (m = t.props, b = "prototype" in T && T.prototype.render, C = (h = T.contextType) && i[h.__c], M = h ? C ? C.props.value : h.__ : i, u.__c ? g = (p = t.__c = u.__c).__ = p.__E : (b ? t.__c = p = new T(m, M) : (t.__c = p = new k(m, M), p.constructor = T, p.render = N), C && C.sub(p), p.props = m, p.state || (p.state = {}), p.context = M, p.__n = i, a = p.__d = !0, p.__h = [], p._sb = []), b && null == p.__s && (p.__s = p.state), b && null != T.getDerivedStateFromProps && (p.__s == p.state && (p.__s = d({}, p.__s)), d(p.__s, T.getDerivedStateFromProps(m, p.__s))), v = p.props, w = p.state, p.__v = t, a) b && null == T.getDerivedStateFromProps && null != p.componentWillMount && p.componentWillMount(), b && null != p.componentDidMount && p.__h.push(p.componentDidMount); else {
    ...
    p.state = p.__s, null != p.getChildContext && (i = d(d({}, i), p.getChildContext())), b && !a && null != p.getSnapshotBeforeUpdate && (_ = p.getSnapshotBeforeUpdate(v, w)), P(n, y(L = null != h && h.type === x && null == h.key ? h.props.children : h) ? L : [L], t, u, i, o, r, e, f, c, s), p.base = t.__e, t.__u &= -161, p.__h.length && e.push(p), g && (p.__E = p.__ = null)
  } catch (n) {
...
function O(l, t, u, i, o, r, e, f, c) {
  ...
  if (null === b) x === k || f && l.data === k || (l.data = k); else {
    if (r = r && n.call(l.childNodes), x = u.props || p, !f && null != r) for (x = {}, s = 0; s < l.attributes.length; s++) x[(d = l.attributes[s]).name] = d.value;
    for (s in x) if (d = x[s], "children" == s) ; else if ("dangerouslySetInnerHTML" == s) a = d; else if ("key" !== s && !(s in k)) {
    ...
    if (h) f || a && (h.__html === a.__html || h.__html === l.innerHTML) || (l.innerHTML = h.__html), t.__k = []; else if (a && (l.innerHTML = ""), P(l, y(v) ? v : [v], t, u, i, "foreignObject" === b ? "http://www.w3.org/1999/xhtml" : o, r, e, r ? r[0] : u.__k && m(u, 0), f, c), null != r) for (s = r.length; s--;) null != r[s] && w(r[s]);
...
function V(t, u, i) {
  var o, r, e, f;
  l.__ && l.__(t, u), r = (o = "function" == typeof i) ? null : i && i.__k || u.__k, e = [], f = [], A(u, t = (!o && i || u).__k = _(x, null, [t]), r || p, p, u.namespaceURI, !o && i ? [i] : r ? null : u.firstChild ? n.call(u.childNodes) : null, e, !o && i ? i : r ? r.__e : u.firstChild, o, f), F(e, t, f)
}
...
n = a.slice, l = {
  ...
  var t = {
    __c: l = "__cC" + h++, __: n, Consumer: function (n, l) {
      return n.children(l)
    }, Provider: function (n) {
      var t, u;
