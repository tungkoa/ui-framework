var d = {
    _catchError: function (e, n, t, o) {
      for (var r, l, i; n = n._parent;) if ((r = n._component) && !r._processingException) try {
        if ((l = r.constructor) && null != l.getDerivedStateFromError && (r.setState(l.getDerivedStateFromError(e)), i = r._dirty), null != r.componentDidCatch && (r.componentDidCatch(e, o || {}), i = r._dirty), i) return r._pendingError = r;
      } catch (n) {
        e = n;
      }
      throw e;
...
const options = /** @type {import('./internal').Options} */d;
...
function useReducer(reducer, initialState, init) {
  ...
  if (!hookState._component) {
    hookState._value = [!init ? invokeOrReturn(undefined, initialState) : init(initialState), action => {
