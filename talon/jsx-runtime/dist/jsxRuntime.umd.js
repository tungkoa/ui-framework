(function (global, factory) {
	...
	(global = global || self, factory(global.jsxRuntime = {}, global.talon));
	...
	function createVNode(type, props, key, isStaticChildren, __source, __self) {
	  ...
	  if (talon.options.vnode) talon.options.vnode(vnode);
	  return vnode;
	}
	...
	function jsxTemplate(templates) {
	  var vnode = createVNode(talon.Fragment, {
	    tpl: templates,
	...
	function jsxAttr(name, value) {
	  if (talon.options.attr) {
	    var result = talon.options.attr(name, value);
	...
	Object.defineProperty(exports, 'Fragment', {
		enumerable: true,
		get: function () { return talon.Fragment; }
	});
